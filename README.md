Requires **pygame-ce**, not pygame.

Making a "game engine" using PyGame, all in one file. The user can import modules and use them to make a game quickly, without writing a lot of code.
